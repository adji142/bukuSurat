...
<div id="content">
	<div id="content-header">
		<div id="breadcrumb"> <a href="<?php echo base_url(); ?>" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">Laporan Pemusnahan Surat</a> </div>
	</div>
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="widget-box">
				<div class="widget-title"> 
		            <h5>Laporan Pemusnahan</h5>
		        </div>
		...
		function bindGrid(data) {
			$("#gridContainer").dxDataGrid({
		        ...
		        onExporting: function(e) {
			      ...
			      var worksheet = workbook.addWorksheet('Pemusnahan Surat');
			      ...
			      DevExpress.excelExporter.exportDataGrid({
			        ...
			        workbook.xlsx.writeBuffer().then(function(buffer) {
			          saveAs(new Blob([buffer], { type: 'application/octet-stream' }), 'DaftarPemusnahansurat.xlsx');
			        });
			      });
			      e.cancel = true;
			    },
