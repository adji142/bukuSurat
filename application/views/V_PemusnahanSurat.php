...
<div id="content">
	<div id="content-header">
		<div id="breadcrumb"> <a href="<?php echo base_url(); ?>" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">Pemusnahan Surat</a> </div>
	</div>
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="widget-box">
				<div class="widget-title"> 
		            <h5>Pemusnahan Surat</h5>
		        </div>
		...
		<div class="modal-content">
			<div class="modal-header">
		        <h5 class="modal-title" id="exampleModalLabel">
		        	<div id="title_modal">Data Pemusnahan Surat
		    ...
		    <div class="modal-body">
		    	<form class="form-horizontal" enctype='application/json' id="post_">
		    		<div class="control-group">
						<label class="control-label">Tanggal Pemusnahan :</label>
						<div class="controls controls-row">
				          <input type="date" class="span2 m-wrap" id="WrapOutDate" name="WrapOutDate" required="" value="<?php echo date("Y-m-d"); ?>">
...
<script type="text/javascript">
	$(function () {
		...
		$(document).ready(function () {
	        ...
	        $.ajax({
	          type: "post",
	          url: "<?=base_url()?>Apps/GetPemusnahanSurat",
	          data: {'id':$('#id').val()},
	          dataType: "json",
		...
		$('#post_').submit(function (e) {
			...
			$.ajax({
		        type    :'post',
		        url     : '<?=base_url()?>Apps/CRUD_Pemusnahan',
		        data    : me.serialize(),
		        dataType: 'json',
		        success : function (response) {
		...
		function bindGrid(data) {
			$("#gridContainer").dxDataGrid({
		        ...
		        export: {
		            enabled: true,
		            fileName: "Daftar Pemusnahan Surat"
		        },
		        columns: [
		        	{
		                dataField: "id",
		            ...
		            {
		                dataField: "WrapOutDate",
		                caption: "Tgl. Pemusnahan",
		                allowEditing:false,
		                visible : true
		            },
		            {
...
function SearchData() {
			...
			$.ajax({
	          type: "post",
	          url: "<?=base_url()?>Apps/GetWrapOutLookup",
	          data: {param:param},
	          dataType: "json",
	          success: function (response) {
	          	if (response.success == true) {
