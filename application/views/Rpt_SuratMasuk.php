...
<div id="content">
	<div id="content-header">
		<div id="breadcrumb"> <a href="<?php echo base_url(); ?>" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">Laporan Surat Masuk</a> </div>
	</div>
...
<script type="text/javascript">
	$(function () {
		...
		$('#btproses').click(function () {
	        ...
	        $.ajax({
	          type: "post",
	          url: "<?=base_url()?>Apps/LaporanSuratmasuk",
		...
		function bindGrid(data) {
			$("#gridContainer").dxDataGrid({
		        ...
		        onExporting: function(e) {
			      ...
			      var worksheet = workbook.addWorksheet('Surat Masuk');
			      ...
			      DevExpress.excelExporter.exportDataGrid({
			        ...
			        workbook.xlsx.writeBuffer().then(function(buffer) {
			          saveAs(new Blob([buffer], { type: 'application/octet-stream' }), 'DaftarSuratMasuk.xlsx');
			        });
			      });
			      e.cancel = true;
			    },
