...
<div id="content">
	<div id="content-header">
		<div id="breadcrumb"> <a href="<?php echo base_url(); ?>" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">Surat Masuk</a> </div>
	</div>
		...
		<div class="modal-content">
		    ...
		    <div class="modal-body">
		    	<form class="form-horizontal" enctype='application/json' id="post_">
					...
					<div class="control-group">
						<label class="control-label">Tanggal Pelaksanaan Surat :</label>
						<div class="controls controls-row">
				          <input type="date" class="span2 m-wrap" id="TglPelaksanaanSurat" name="TglPelaksanaanSurat" required="" placeholder="Tanggal Surat">
				        </div>
					</div>
					<div class="control-group">
...
<script type="text/javascript">
	...
	$(function () {
		...
		$(document).ready(function () {
	        ...
	        $.ajax({
	          type: "post",
	          url: "<?=base_url()?>Apps/GetSuratMasuk",
	        ...
	        $.ajax({
	          ...
	          data: {'Kolom':'NoAgenda','Table':'datasurat','Prefix':'M-'+year.toString()+fixmonth.toString()},
	          dataType: "json",
	          success: function (response) {
	          	// bindGrid(response.data);
